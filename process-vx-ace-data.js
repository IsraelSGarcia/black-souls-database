...
// Define paths
const inputDir = path.join(__dirname, 'original-data', 'vx-ace-data');
const outputDir = path.join(inputDir, 'processed-data');
...
async function main() {
    console.log('Starting VX Ace data processing...\n');
